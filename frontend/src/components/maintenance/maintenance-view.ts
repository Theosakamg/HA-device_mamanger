...
export class DmMaintenanceView extends LitElement {
  static styles = [
    ...
    css`
      ...
      .danger-zone {
        border: 2px solid #e57373; border-radius: 8px;
        padding: 24px; margin-bottom: 24px;
      }
      .danger-zone h3 { color: #c62828; margin: 0 0 8px 0; }
      .danger-zone p { color: #666; margin: 0 0 16px 0; font-size: 14px; }
      .danger-action {
        display: flex; align-items: flex-start; gap: 16px;
        padding: 16px; background: #fff8f8; border-radius: 8px;
      ...
      .confirm-dialog .phrase-hint {
        background: #fce4ec; padding: 8px 12px; border-radius: 4px;
        font-family: monospace; font-weight: bold; color: #c62828;
      ...
      .result-panel.error {
        background: #fce4ec; border-color: #ef9a9a;
      }
      ...
      .btn-export {
        padding: 10px 20px; border: 2px solid var(--dm-primary, #03a9f4);
        border-radius: 6px; background: white; cursor: pointer;
        font-weight: 600; font-size: 14px; color: var(--dm-primary, #03a9f4);
        transition: all 0.15s; display: flex; align-items: center; gap: 8px;
      }
      .btn-export:hover { background: var(--dm-primary, #03a9f4); color: white; }
      .btn-export:disabled { opacity: 0.5; cursor: not-allowed; }
      .export-info { font-size: 13px; color: #666; margin-top: 8px; }
    `,
  ];
  ...
  render() {
    return html`
      ...
      <div class="section">
        ...
        <p style="color:#666; font-size:14px; margin:0 0 16px 0;">${i18n.t('export_desc')}</p>
        <div class="export-actions">
          <button class="btn-export" ?disabled=${this._exporting}
        ...
        ${this._exporting ? html`<p class="export-info">${i18n.t('loading')}</p>` : nothing}
        ${this._exportError
      ...
      <div class="danger-zone">
        ...
        <div class="danger-action">
          ...
          <button class="btn-danger"
            @click=${() => { this._showConfirm = true; this._confirmInput = ''; this._cleanResult = null; this._cleanError = null; }}>
